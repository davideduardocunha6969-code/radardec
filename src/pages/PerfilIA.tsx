      ...
      <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Configure a persona, base de conhecimento e contexto organizacional
              </p>
            </div>
          </div>
        </div>
        ...
        <Tabs defaultValue="escritorio" className="space-y-4">
          ...
          <TabsContent value="persona" className="space-y-6">
            ...
            {/* Personality Tabs */}
            <Tabs defaultValue="personaDetail" className="space-y-4">
              <TabsList className="grid grid-cols-4 w-full">
                <TabsTrigger value="personaDetail" className="flex items-center gap-2">
                  <Bot className="h-4 w-4" />
              ...
              <TabsContent value="personaDetail">
                <Card>
                  <CardHeader>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Documente o propósito de cada planilha e aba, e descreva o que cada coluna representa.
                      Quanto mais contexto você fornecer, melhores serão as respostas da IA.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-primary/20 bg-primary/5">
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Estrutura Organizacional</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Defina a hierarquia do escritório, cargos e responsabilidades de cada membro.
                      Isso permite que a IA compreenda o contexto organizacional e forneça análises mais precisas.
                    </p>
                  </div>
                </div>
              </CardContent>
