...
interface ConformityAccuracyDialogProps {
  open: boolean;
...
export function ConformityAccuracyDialog({
  open,
  onOpenChange,
  tasks,
  errors,
}: ConformityAccuracyDialogProps) {
  const accuracyByController = useMemo(() => {
    ...
    // Count errors per controller (using recipient field)
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[80vh]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Taxa de Acerto Conformidade por Controller
          </DialogTitle>
        </DialogHeader>
